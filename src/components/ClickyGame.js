...
class ClickyGame extends Component {
  state = {
    ...
    allInstruments: this.shuffleArray(),
  ...
  shuffleArray() {
    // creates a copy of the current Instruments array to modify it by value, and not by reference
  ...
  checkClicked(clickedElem) {
    ...
    if (this.state.wasClicked.includes(clickedElem)) {
      ...
      return this.setState({
        ...
        navMessage: 'Oh Treble Clef! Back to the first audition with you!',
        allInstruments: shuffled,
        wasClicked: [],
        shake: true
      });
    }
    ...
    this.setState({
      ...
      highScore: highScore,
      navMsgColor: 'correct',
      navMessage: 'Way to keep the beat! On to the next round!',
      allInstruments: shuffled,
  ...
  // passes the randomized state.allInstruments array to Container to create a Character component for each image.
